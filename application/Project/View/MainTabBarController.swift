...
class MainTabBarController: UITabBarController {
    ...
    private func setupTabs() {
        let nav1 = createNav(with: HomeViewController(), title: "Лента", inactiveName: "tap_home", activeName: "tap_home_green")
        let nav2 = createNav(with: ChatViewController(), title: "Гигачат", inactiveName: "tap_chat", activeName: "tap_chat_green")
        let nav3 = createNav(with: ProfileViewController(), title: "Профиль", inactiveName: "tap_profile", activeName: "tap_profile_green")
    ...
    private func setupAppearance() {
        ...
        appearance.stackedLayoutAppearance.normal.titleTextAttributes = [.font: font, .foregroundColor: UIColor.gray]
        appearance.stackedLayoutAppearance.selected.titleTextAttributes = [.font: font, .foregroundColor: UIColor.white]
